...
export const ElectroBorder: React.FC<ElectroBorderProps> = ({
    ...
    return (
        ...
        >
            ...
            {effects && overlay && (
                <div
                    className="absolute inset-0 pointer-events-none opacity-80 dark:opacity-100 mix-blend-overlay scale-105"
                    style={{
                        borderRadius: parsedRadius,
                        filter: "blur(16px)",
            ...
            {effects && overlay && (
                <div
                    className="absolute inset-0 pointer-events-none opacity-40 dark:opacity-50 mix-blend-overlay scale-105"
                    style={{
                        borderRadius: parsedRadius,
                        filter: "blur(16px)",
                        background: "linear-gradient(-30deg, white, transparent 30%, transparent 70%, white)",
            ...
            {effects && aura && (
                <div
                    className="absolute inset-0 pointer-events-none -z-10 scale-110 opacity-30 dark:opacity-40"
                    style={{
                        borderRadius: parsedRadius,
                        filter: `blur(${glowBlur}px)`,
                        background: `linear-gradient(-30deg, ${electricLight}, transparent, ${borderColor})`,
                    }}
                />
            )}
